...
def render_latex_table(
    ...
    if factor_name == "topology":
        convention_text = (
            ...
            rf"interval from {repetitions:,} within-configuration replicates. Only "
            rf"cells with $n_{{c,k}}\geq2$ contribute to both summaries."
        )
    else:
        convention_text = (
    ...
    lines = [
        ...
        (
            ...
            rf"and all-observed energy dispersion across {workload_text}.{convention_text}"
            rf"{interval_note}}}}}"
        ),
        rf"\label{{{label}}}",
        ...
        (
            ...
            r"\multicolumn{5}{c}{\textbf{Energy (kWh; all obs.)}} \\"
        ),
