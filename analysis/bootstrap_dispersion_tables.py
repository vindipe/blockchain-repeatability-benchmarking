...
def render_latex_table(
    ...
    lines = [
        ...
        (
            ...
            rf"and energy dispersion across {workload_text}. Each metric block reports "
            rf"contributing cells $C$, metric-eligible observations $N_k$, their "
            rf"run-count range $n_{{c,k}}$, and unweighted mean and median IQR\% and "
            rf"Std\%, with 95\% percentile bootstrap intervals from {repetitions:,} "
            rf"within-configuration replicates.{interval_note}}}}}"
        ),
        rf"\label{{{label}}}",
        ...
        (
            ...
            r"\multicolumn{7}{c}{\textbf{Latency}} & "
            r"\multicolumn{7}{c}{\textbf{Energy}} \\"
        ),
