"""Generate the six-workload catalog and observed outcome counts for M1."""
...
WORKLOADS = {
    ...
    "GAFAM": {
        ...
        "offered_load": "20,000-TPS initial burst",
...
def render_table(catalog: pd.DataFrame) -> str:
    lines = [
        r"\begin{table*}[t]",
        r"\centering",
        r"\caption{Six workload profiles and observed outcome accounting. Offered loads and trace characteristics follow the released Diablo workload definitions; counts refer to the selected repeated-execution corpus.}",
