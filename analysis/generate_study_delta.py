"""Generate the audited ACM-DLT versus IEEE Access study delta for M8/R2.5."""
...
def render_table() -> str:
    lines = [
        ...
        r"\begin{table*}[t]",
        r"\centering",
        r"\caption{\vd{M8/R2.5: Published ACM DLT content and analysis introduced in this IEEE Access submission. The shared framework, corpus, experimental factors, P0--P3 ladder, and basic dispersion definitions are not claimed as new.}}",
