...
class ICCModelTests(unittest.TestCase):
    ...
    def test_cluster_bootstrap_is_seed_reproducible(self):
        ...
        for statistic in first:
            np.testing.assert_allclose(first[statistic], second[statistic])
    ...
    def test_generated_table_uses_fixed_table_font(self):
            ...
            [
                {
                    ...
                    "n_configurations": 3,
                    "n_observations": 30,
                    "between_configuration_variance": 0.6,
                    "between_configuration_variance_ci_lower": 0.4,
                    "between_configuration_variance_ci_upper": 0.8,
                    "within_configuration_variance": 0.2,
                    "within_configuration_variance_ci_lower": 0.1,
                    "within_configuration_variance_ci_upper": 0.3,
                }
        ...
        self.assertIn(r"\begin{tabular}{lccc}", latex)
        ...
        self.assertIn(r"\caption{\vd[R1.9/R2.4]{", latex)
        self.assertIn(r"\TableFont", latex)
        self.assertIn(r"$\hat{\tau}^2=0.600$", latex)
        self.assertIn(r"$\hat{\sigma}^2=0.200$", latex)
        self.assertIn("ICC=0.500", latex)
